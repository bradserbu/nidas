...
static int z85_isa_attach(int isa_io, int isa_irq)
{
	struct z85_adapter *sad;
	...
	z85_isa_adapter[i] = sad;

	return 0;
}

static void z85_isa_detach(int index);
{
	struct z85_adapter *sad = z85_isa_adapter[i];
	z85_isa_adapter[i] = NULL;
